...
class LoanServiceTest {
    ...
    void borrowNonExistingBook_ShouldThrowException() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> loanService.borrow("999999", "Ali"));
        assertEquals("Book not found", ex.getMessage());
    }

    @Test
    void borrowNonExistingMember_ShouldThrowException() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> loanService.borrow("123456", "NonExist"));
    ...
    void borrowAlreadyBorrowedBook_ShouldThrowException() {
        ...
        Exception ex = assertThrows(IllegalStateException.class, () -> loanService.borrow("123456", "Ali"));
    ...
    void findLatestLoans_ShouldReturnLatestLoansByBorrowDate() {
        loanService.borrow("123456", "Ali");
        LoanRepository.save(new Loan("999777", "Ali", LocalDate.now().minusDays(2), LocalDate.now().plusDays(1)));
    ...
    void borrowMedia_Generic_WhenMediaAlreadyBorrowed_ShouldThrow() {
        ...
        assertThrows(IllegalStateException.class, () -> loanService.borrowMedia(member, media, LocalDate.now()));
    }
    ...
    void borrowMediaTestDuration_ShouldCreateTestingLoan() {
        ...
        Loan loan = loanService.borrowMediaTestDuration(member, media, LocalDate.now(), 0, 0, 0, 5);
